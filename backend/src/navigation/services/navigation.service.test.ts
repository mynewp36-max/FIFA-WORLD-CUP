...
describe('NavigationService', () => {
  ...
  it('should call AiService and return result', async () => {
    ...
    const res = await NavigationService.getRoute(reqData as any, 'user-1');
  ...
  it('should propagate errors from AiService', async () => {
    ...
    await expect(NavigationService.getRoute(reqData as any, 'user-1')).rejects.toThrow('AI Error');
  });
});