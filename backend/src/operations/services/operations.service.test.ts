...
describe('OperationsService', () => {
  ...
  it('should call AiService and return result', async () => {
    ...
    const res = await OperationsService.generateSummary(reqData as any, 'user-1');
  ...
  it('should propagate errors from AiService', async () => {
    ...
    await expect(OperationsService.generateSummary(reqData as any, 'user-1')).rejects.toThrow('AI Error');
  });
});